...
<div class="preview-content-wrapper">
    ...
    <div id="primary" class="content-area">
        <main id="main" class="top-page-content" role="main">
            ...
            <!-- 4. トレンドセクション -->
            <section style="margin-bottom: 40px;">
                <h2 class="title-h2__text title-h2__text--category">デザイントレンド</h2>
                <div class="new-article-list">
                    <?php
        ...
        <aside class="right-contents">
            <div id="custom-side-nav" class="widget-area">
                <!-- プロフィールカード -->
                ...
                <div class="popular-tag">
                    ...
                    <ul class="popular-tag-list">
                        ...
                        // 上位5件を取得
                        $top_tags = array_slice($tag_counts, 0, 5);

                        if (!empty($top_tags)) {
                            foreach ($top_tags as $t) {
                                echo '<li><a href="' . esc_url(get_tag_link($t['term_id'])) . '" class="tag">' . esc_html($t['name']) . '</a></li>';
                            }
                        } else {
                            echo '<li>タグがありません</li>';
                        }
                ...
                <div class="sns">
                    ...
                    <ul class="sns-icon-list">
                        <li class="sns-icon">
                            <a href="https://twitter.com" target="_blank" aria-label="X (Twitter)" style="display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; border-radius: 50%; background: #1a1a1a; color: #fff; font-size: 24px;">
                                <i class="fa-brands fa-x-twitter"></i>
                            </a>
                        </li>
                        <li class="sns-icon">
                            <a href="https://instagram.com" target="_blank" aria-label="Instagram" style="display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; border-radius: 50%; background: linear-gradient(45deg, #f9ce34, #ee2a7b, #6228d7); color: #fff; font-size: 24px;">
                                <i class="fa-brands fa-instagram"></i>
                            </a>
                        </li>
                        <li class="sns-icon">
                            <a href="https://note.com" target="_blank" aria-label="note" style="display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; border-radius: 50%; background: #00ca90; color: #fff; font-size: 24px; font-weight: bold; font-family: sans-serif; text-decoration: none;">
                                N
                            </a>
                        </li>
                    </ul>
