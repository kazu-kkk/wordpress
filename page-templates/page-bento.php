		...
		<main id="main" class="site-main" role="main">
			...
			<div class="bento-wrapper">
				<div class="bento-grid">
					...
					<!-- Instagram -->
					<a href="https://www.instagram.com/dspedia_byyuny?igsh=MW1kZnF1YWc5aHpoag%3D%3D&utm_source=qr" target="_blank" class="bento-card social-card instagram">
						<div class="card-icon">
					...
					<!-- YouTube -->
					<a href="https://www.youtube.com/@y.n.1210" target="_blank" class="bento-card social-card youtube">
						<div class="card-icon">
							<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" viewBox="0 0 16 16">
					...
					<!-- X (Twitter) -->
					<a href="https://x.com/mdspediabyyuny?s=11" target="_blank" class="bento-card social-card twitter">
						<div class="card-icon">
							<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" viewBox="0 0 16 16">
