...
&lt;/div&gt;</code></pre>
                ...
                <section id="c-blogcard" class="showcase-section">
                    ...
                    <div class="showcase-desc">
                        記事本文内で関連記事などの内部リンクをリッチにアピールするためのブログカードです。サムネイル枠はサイトのアイキャッチ画像（1376×768px）と同じ「16:9」に設定されており、左右が見切れることなく美しく表示されます。ホバー時は枠線色（#c4d2f6）の変化とサムネイル画像の微ズームのみで、カード自体の浮き上がりを抑えた落ち着いたインタラクションです。また、記事本文内のリンク下線（underline）の指定を受けないよう保護されています。
                    </div>
                    <div class="showcase-preview-wrapper">
                        <div class="showcase-control-bar">
                            <div class="showcase-control-group">
